<template>
  ...
  >
    ...
    <div ref="contentRef" class="notice-content" @scroll="handleScroll">
      ...
      <ul>
        <li>系统将使用用户提供的信息前往官方网站查询成绩。所有用户信息在入库前均经过 SHA-256 单向加密处理，数据库中不存储任何明文数据，管理员亦无法查看用户原始信息。</li>
        <li>由于查询需实时访问官方网站，过程可能存在一定延迟。请勿重复提交或频繁刷新页面，以免影响查询结果。</li>
        <li>开发不易，如果本项目对您有帮助，欢迎在 GitHub 上点个 Star 支持一下😄</li>
        <li>也欢迎对技术开发感兴趣的同学了解我们团队。老师人不错，毕业去向也很好，欢迎联系。😄</li>
      </ul>
      <p>继续使用即表示您已知悉上述内容。</p>
    </div>
    <template #footer>
